  ...
  return (
    <div className="sp-search-page">
      ...
      <style jsx>{`
        ...
        .sp-view-product-card-btn:hover {
          background: #059669;
        ...
        .sp-visit-site-btn:hover:not(:disabled) {
          background: rgba(255, 255, 255, 0.08);
          color: #fff;
          border-color: rgba(255, 255, 255, 0.3);
        }
        .sp-visit-site-btn:disabled {
          opacity: 0.4;
          cursor: not-allowed;
        }
  ...
  return (
    <header className="app-header flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-1">
        ...
        {/* Mobile Search Button (Circle Pill) */}
        <button
          onClick={onSearchClick}
      ...
      <section className="max-w-5xl mx-auto bg-black border border-white/10 rounded-xl shadow-xl overflow-hidden">
        ...
        <div className="px-6 md:px-10 py-8">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="/contact"
              className="px-6 py-3 rounded-full bg-[#15A148] text-black font-semibold hover:bg-[#15A148]"
            >
              Contact Sales
            </a>
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 animate-fade-in">
      <main className="mx-auto w-full max-w-7xl px-4 py-6">
        {/* Redesigned Premium Solid Light Header */}
        <section 
          className="relative w-full rounded-3xl border p-6 md:p-8 flex flex-col gap-6 overflow-hidden transition-all duration-300"
          style={{
            background: "#f8fafc",
            borderColor: "#e2e8f0",
        ...
        >
          {/* Top Glass Highlights & Ambient Glow Rings */}
          <div className="absolute top-0 right-1/4 w-96 h-96 bg-transparent rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-transparent rounded-full blur-3xl pointer-events-none" />

          <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6 w-full">
            {/* Logo frame with brand green drop shadow */}
            <div 
              className="relative p-1.5 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-105 animate-fade-in"
              style={{
                background: "#15A148",
                boxShadow: "0 4px 15px rgba(21, 161, 72, 0.2)"
              }}
            >
              {company.logoUrl ? (
                <img
                  ...
                  className="h-24 w-24 rounded-full object-contain bg-white p-2 border border-slate-200"
                  onError={(e) => {
                ...
                <div className="h-24 w-24 rounded-full bg-[#15A148] flex items-center justify-center font-black text-xl text-white">
                  {company.name.charAt(0)}
                </div>
              )}
            </div>

            {/* Business Text Details & Category */}
            <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-3">
              <div className="flex flex-col gap-1.5 items-center md:items-start">
                <h2 className="text-2xl md:text-3.5xl font-extrabold tracking-tight text-slate-800">
                  {company.name}
                </h2>
                <span className="px-3.5 py-1 text-[11px] font-bold rounded-full bg-[#15A148]/10 text-[#15A148] border border-[#15A148]/20 uppercase tracking-wider">
                  {company.category || "SaaS & IoT"}
                </span>
              </div>
              <p className="text-sm text-slate-600 md:text-base leading-relaxed max-w-2xl font-light">
                {company.description || "Welcome to our premium business profile. Explore our posts and products catalog below."}
              </p>
            </div>

            {/* Premium action buttons with beveled scale feedback */}
            <div className="flex flex-wrap md:flex-col items-center md:items-end gap-3 justify-center">
              {company.isAiChatEnabled && (
                <button
                  ...
                  className="w-[125px] h-10 rounded-xl bg-[#15A148] hover:bg-[#0f8a3a] text-xs font-bold text-white transition-all duration-300 hover:scale-105 active:scale-95 border border-[#15A148]/30 shadow-[0_4px_12px_rgba(21, 161, 72, 0.2)] flex items-center justify-center gap-1.5 animate-pulse"
                >
                  <Bot size={13} /> AI Chat
                </button>
              )}
              ...
              <button
                ...
                className="w-[125px] h-10 rounded-xl bg-[#1b4fd8] hover:bg-[#123cb2] text-xs font-bold text-white transition-all duration-300 hover:scale-105 active:scale-95 border border-[#1b4fd8]/30 shadow-[0_4px_12px_rgba(27, 79, 216, 0.2)] flex items-center justify-center gap-1.5"
              >
                <Sparkles size={13} className="text-white" /> Visit Site
              </button>

              <button
                onClick={handleFollow}
                disabled={followLoading}
                className="w-[125px] h-10 rounded-xl text-xs font-bold transition-all duration-300 hover:scale-105 active:scale-95 flex items-center justify-center disabled:cursor-not-allowed disabled:opacity-60"
                style={{
                  background: isFollowing ? "#f1f5f9" : "#15A148",
                  color: isFollowing ? "#1e293b" : "white",
                  border: isFollowing ? "1px solid #e2e8f0" : "none",
                  boxShadow: isFollowing ? "none" : "0 4px 12px rgba(21, 161, 72, 0.2)"
                }}
              >
                {followLoading ? (
          ...
          {/* Interactive Statistics Grid with solid dividers */}
          <div 
            className="relative z-10 grid grid-cols-3 w-full mt-2 text-center rounded-2xl p-4 md:p-5 border border-slate-200"
            style={{
              background: "#f1f5f9"
            }}
          >
            <div className="border-r border-slate-200 flex flex-col gap-0.5">
              <h4 className="text-xl md:text-2xl font-black text-slate-800 leading-none tracking-tight">
                {posts.length}
              </h4>
              <span className="text-[10px] md:text-[11px] font-bold text-slate-500 uppercase tracking-wider mt-1">
                Posts
              </span>
            </div>
            <div className="border-r border-slate-200 flex flex-col gap-0.5">
            ...
            <div className="flex flex-col gap-0.5">
              <h4 className="text-xl md:text-2xl font-black text-[#15A148] leading-none tracking-tight">
                {followers}
              </h4>
              <span className="text-[10px] md:text-[11px] font-bold text-slate-500 uppercase tracking-wider mt-1">
                Followers
                    ...
                    <button
                      ...
                      className={`rounded-full px-4 py-2 text-sm transition-all font-semibold ${
                        activePostCategory === category
                          ? "bg-[#15A148] text-white shadow-lg shadow-green-600/30"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 w-full">
                  {filteredPosts.length > 0 ? (
                    filteredPosts.map((post, postIndex) => (
                      <div
                        key={post._id}
                        className="aspect-square relative overflow-hidden rounded-xl group cursor-pointer border border-white/10 bg-zinc-900 shadow-md transition-all hover:border-white/20"
                    ...
                    <p className="text-zinc-400 p-8 text-center col-span-full w-full">No posts yet.</p>
                  )}
                </div>
              </div>
            )}
                    ...
                    filteredProducts.map((product) => (
                      ...
                      >
                        ...
                        <div className="p-3">
                          ...
                          <p className="mt-1 text-sm text-green-400">â‚¹{product.price}</p>
                        </div>
                      </div>
                    ))
                  ) : (
      ...
      <footer className="bg-slate-50 text-slate-800 border-t border-slate-200 mt-12 px-6 py-12">
         <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col space-y-6 lg:pl-10">
              ...
              <nav className="flex flex-col gap-3 text-slate-600 text-sm font-medium">
                <a href="/" onClick={(e) => { e.preventDefault(); navigate("/"); }} className="hover:text-[#15A148] transition-colors">Home</a>
                <a href="/blogs" onClick={(e) => { e.preventDefault(); navigate("/blogs"); }} className="hover:text-[#15A148] transition-colors">Blog</a>
                <a href="#about" className="hover:text-[#15A148] transition-colors">About</a>
                <a href="#posts" className="hover:text-[#15A148] transition-colors">Posts</a>
                <a href="#contact" className="hover:text-[#15A148] transition-colors">Contact</a>
                <a href="#terms" className="hover:text-[#15A148] transition-colors">Terms</a>
                <a href="#privacy" className="hover:text-[#15A148] transition-colors">Privacy</a>
              </nav>
            </div>
          ...
          <div className="border-t border-slate-200 pt-6 text-slate-500 text-xs leading-relaxed space-y-2">
            ...
            <p>
              If you are a website owner and would like your site removed from Zooda, please email <a href="mailto:zoodanew@gmail.com" className="text-[#15A148] hover:underline">zoodanew@gmail.com</a> and we will process the removal request.
            </p>
          </div>
...
const useHistoryRouter = () => {
  ...
  useEffect(() => {
    // If initial URL contains hashtag, cleanse and rewrite immediately!
    const hash = window.location.hash;
    if (hash && (hash.startsWith("#/") || hash.startsWith("#"))) {
...
const INITIAL_BLOGS: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "3 min read",
    excerpt: "Actionable, simple storefront marketing hacks leveraging micro-promotions, local marketing, and highly engaging digital flyers to boost local foot-traffic.",
    content: `
